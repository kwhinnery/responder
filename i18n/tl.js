...
module.exports = {
    ...
    // interview steps
    , start: '[tl] For TB information in English, text "1". [waray]For TB information in Waray, text "2". [fil]For TB information in Pilipino, text "3"'
    , province: '[tl] Thank you for contacting the TB information line. What province are you in (Example: %s)?'
    ...
    , barangayFound: '[tl] Based on what you have told us, your nearest TB treatment center is %s'
