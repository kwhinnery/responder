...
module.exports = {
    ...
    , purposeConfirm: 'Your report will help international aid workers understand current areas of need. If you need help right now, please contact local authorities. Continue? (Text "%s" or "%s")'
